...
Apple Invites desktop app for Windows. Loads [icloud.com/invites](https://www.icloud.com/invites) in a native **Tauri / WebView2** shell.
...
- **Deep link** — `apple-invites://` protocol handler
