...
A native Windows application for accessing [Apple Invites](https://www.icloud.com/invites) from iCloud.com.

## Features

- **System Tray Integration** - Runs in the background, keeping your session alive
...
- **Shared Authentication** - Sign in once and stay logged in across related Apple apps
...
1. Download the latest installer from [Releases](https://github.com/taylorivanoff/apple-invites-windows/releases)
